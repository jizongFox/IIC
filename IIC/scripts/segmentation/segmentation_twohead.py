...
parser.add_argument("--fine_to_coarse_dict", type=str,  # COCO
                    default="/home/jizong/tmp/IIC_origin/IIC/datasets/segmentation/util/out/fine_to_coarse_dict.pickle")
...
config.output_k = config.output_k_B  # for eval IIC
